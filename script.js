// 👈 تم وضع رابط النشر الجديد الخاص بك هنا
const API_URL = "https://script.google.com/macros/s/AKfycbwcv2lManEf4aloQcq3v43YDE4CjD5IJTh_5WDklhEJol3C6UDQfS95v8v_MOCc9rJL/exec";
...
function checkout() {
    ...
    reader.onload = e => { 
        ...
        .then(responseText => {
            ...
            // استخراج رابط الصورة
            let finalLink = "لم يتم إرجاع الرابط";
            ...
            setTimeout(() => {
                ...
                // 👈 الحل النهائي لتعليق الصفحة: تحديث الصفحة وإخفاء النافذة بعد ثانيتين
                setTimeout(() => {
