...
const API_URL = "https://script.google.com/macros/s/AKfycbwbzAV8W7CZgbXDFprEOxbuPTKABI6gGkg09_HZtjv9HMe_5Wx7D7JrA84Y2sUPvvYwrg/exec";
    ...
    reader.onload = e => { 
        ...
        .then(responseText => {
            ...
            setTimeout(() => {
                ...
                // إغلاق النافذة المعلقة وتحديث الصفحة
                setTimeout(() => {
