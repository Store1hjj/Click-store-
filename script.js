...
// ✅ تم دمج الرابط الجديد الخاص بك
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbwjfTgMNyK_fIwJAcfYyOZK73bZYZNRBl7koVB9zy5Wrci9G7BCO5zdY_eSevwMuE5O/exec';
...
async function checkout() {
    ...
    try {
        ...
        // معالجة وضغط الصورة لضمان الإرسال السريع
        ...
        // ⏳ انتظار رد جوجل سكريبت لإحضار رابط الصورة
        ...
        // قراءة الرابط الذي أرسله السكربت
        let fileUrl = await response.text();
        fileUrl = fileUrl.trim();

        // 🔗 دمج الرابط الحقيقي في رسالة الواتساب
        ...
        alert(currentLang === 'ar' ? "❌ حدث خطأ في الاتصال، يرجى المحاولة مرة أخرى." : "❌ Erreur de connexion, veuillez réessayer.");
    } finally {
        btn.disabled = false;
...
// ضغط الصورة قبل الرفع لضمان السرعة وعدم التقطع
