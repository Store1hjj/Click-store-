...
// ⚠️ ضع رابط سكربت الإرسال الجديد هنا (بعد عمل Deploy جديد)
...
function toggleLanguage() {
    ...
    updateCartUI(); // تحديث النصوص داخل السلة
}
...
function renderProducts(productsList) {
    ...
    for (const [category, items] of Object.entries(groupedProducts)) {
        ...
        items.forEach(p => {
            ...
            // ⚠️ الأزرار هنا تم برمجة الزائد على اليسار والناقص على اليمين بناءً على dir="ltr" في الـ CSS
            card.innerHTML = `
                <div style="width:100%;">
