...
// --- الترجمة الحقيقية (نفس نصوصك بالضبط) ---
const translations = {
    ar: {
        ...
        checkout_btn: '<i class="fab fa-whatsapp" style="font-size:1.3rem;"></i> تأكيد طلبك في واتساب',
        promo_btn: 'تفعيل',
    ...
    fr: {
        ...
        checkout_btn: '<i class="fab fa-whatsapp" style="font-size:1.3rem;"></i> Confirmez votre commande',
        promo_btn: 'Appliquer',
...
async function checkout() {
    ...
    try {
        ...
        // 🚀 هذا هو التعديل السحري: يجبر المتصفح على التحويل الإجباري في نفس النافذة
        ...
        fetchProducts(); 
        // لا نغلق السلة فوراً لكي لا ينقطع التحويل عن بعض الأجهزة البطيئة
        
    } catch (error) {
        alert(currentLang === 'ar' ? "❌ حدث خطأ، يرجى المحاولة مرة أخرى." : "❌ Une erreur s'est produite, veuillez réessayer.");
        btn.disabled = false;
        btn.innerHTML = translations[currentLang]['checkout_btn'];
    } 
}
