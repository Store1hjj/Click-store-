...
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxS9WMiG4AL59lTqpJJlvESx4DMzW4pLmf6-xUUf-_MPqaSkgqq5e8sPbklmlZ5siGgwQ/exec';
...
async function checkout() {
    ...
    try {
        ...
        // ⏳ انتظار رد السكربت لجلب الرابط الحقيقي
        ...
        // التحويل للواتساب بعد جلب الرابط 🚀
        ...
        alert(currentLang === 'ar' ? "❌ حدث خطأ في الرفع، يرجى المحاولة مرة أخرى." : "❌ Erreur de téléchargement, veuillez réessayer.");
    } finally {
        btn.disabled = false;
